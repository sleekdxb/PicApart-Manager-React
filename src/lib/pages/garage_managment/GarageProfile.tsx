    ...
    <div className="mt-2  grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        {/* ============= activity metrics section ============= */}
            <div className=" border rounded p-2 bg-white transition-transform duration-200 hover:-translate-y-1 hover:shadow-md">
              ...
              <ActivityMetricRow iconSrc={requests} iconBgClassName="bg-[#DBEAFE]" title="Requests Received" periodText="Last 30 days" valueText="142" valueClassName="text-[#3E38DA]" />
              <ActivityMetricRow iconSrc={listingclicks} iconBgClassName="bg-[#DBEAFE]" title="Listing Clicks" periodText="Last 30 days" valueText="856" valueClassName="text-[#028174]" />
              <ActivityMetricRow iconSrc={calls} iconBgClassName="bg-[#F2E7FF]" title="Calls to Vendors" periodText="Last 30 days" valueText="67" valueClassName="text-[#9333EA]" />
              <ActivityMetricRow iconSrc={chat} iconBgClassName="bg-[#FEF9C3]" title="Chats with Vendors" periodText="Last 30 days" valueText="89" valueClassName="text-[#CA8A04]" />
            </div>
</div>  
          {/* ========== Documents ========== */}
...
<div className="w-full mt-4 border rounded p-4 bg-white transition-transform duration-200 hover:-translate-y-1 hover:shadow-md">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <DocumentRow iconSrc={pdf} title="Trade License" statusText="Valid" statusClassName="text-[#028174] bg-[#CAFFDC]" subText="Expires: December 31, 2025" />
    <DocumentRow iconSrc={pdf} title="Proof of Location" statusText="Valid" statusClassName="text-[#028174] bg-[#CAFFDC]" subText="Expires: December 31, 2025" />
  </div>
