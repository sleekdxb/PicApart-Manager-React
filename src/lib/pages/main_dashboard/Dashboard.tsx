...
//           { staff_id: "612dd1f0-8cd5-41f5-8b82-17cd40144e52", sta_goal: "overview" },
//         ]);
//         if (cancelled) return;
...
//               <QuickActionItem title="Approve Dealers" iconSrc={approvedealers} badgeSrc={number} />
//               <QuickActionItem title="Respond Tickets" iconSrc={respondtickets} badgeSrc={number} />
//               <QuickActionItem title="View Alerts" iconSrc={viewalerts} />
//               <QuickActionItem title="Generate Report" iconSrc={generatereport} />
//             </div>
